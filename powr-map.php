<?php
    ...
    Description: Add interactive, customized maps to your page in seconds! Add the widget to your theme, or create a Map on ANY page or post by using the shortcode [powr-map]. Then, simply visit your site and click the settings icon to customize your Map right in the page. Many more plugins & tutorials at POWr.io.
    Author: POWr.io
    Version: 1.1
    ...
    */
    ...
    class Powr_Map extends WP_Widget{
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Map.
        </p>
        <p>
