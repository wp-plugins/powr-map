<?php
    ...
    Description: Create and customize interactive maps for any location. Add the widget to your theme, or create a Map on ANY page or post by using the shortcode [powr-map]. Then, simply visit your site and click the settings icon to customize your Map right in the page. Many more plugins & tutorials at POWr.io.
    Author: POWr.io
    Version: 1.0
